...
Android app available from [Google Play](https://play.google.com/store/apps/details?id=taximeter).

Please see the [issues](https://github.taximeter/com-mibarim-main/issues) section
...
<a href="https://play.google.com/store/apps/details?id=taximeter" alt="Download from Google Play">
...
All import statments that reference the old resources (__R.taximeter.R__) will now be renamed
...
## Contributors
Thank you to all the [contributors](http://www.github.taximeter/com-mibarim-main/contributors) on
...
[pull requests](https://github.taximeter/com-mibarim-main/pulls).
