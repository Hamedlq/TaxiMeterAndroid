...
public class SuggestRouteButtonsFragment extends Fragment {
    ...
    @Bind(R.id.accept_route)
    protected BootstrapButton accept_route;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        accept_route.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ((SuggestRouteActivity) getActivity()).AcceptSuggestRoute();
                    return true;
                }
                return false;
            }
