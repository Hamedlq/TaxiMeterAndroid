 ...
 */
public class GroupActivity extends BootstrapActivity {
    ...
    private int selectedSuggestGroupId;
    ...
    public void onNetworkErrorEvent(NetworkErrorEvent event) {
        Toaster.showLong(GroupActivity.this, getString(R.string.network_error), R.drawable.toast_warn);
    }
    ...
    public Bitmap getRouteImage(final long routeId, final String requestedFragment) {
        new SafeAsyncTask<Boolean>() {
            ...
            public Boolean call() throws Exception {
                authToken = serviceProvider.getAuthToken(GroupActivity.this);
...
//                    finish();
    ...
    public void getRouteImage(final ImageView imageView, final int routeId) {
        new SafeAsyncTask<Boolean>() {
            ...
            @Override
            public Boolean call() throws Exception {
                String token = serviceProvider.getAuthToken(GroupActivity.this);
    ...
    public void leaveGroup() {
        new SafeAsyncTask<Boolean>() {
            ...
            public Boolean call() throws Exception {
                ...
                response = routeRequestService.leaveGroup(authToken, String.valueOf(theRoute.RouteId),
                        String.valueOf(theRoute.GroupRoutes.get(0).GroupId));
...
//                    finish();
            ...
            protected void onSuccess(final Boolean succees) throws Exception {
                if (!succees) {
                    new HandleApiMessages(GroupActivity.this, response).showMessages();
                } else {
                    finishIt();
                }
