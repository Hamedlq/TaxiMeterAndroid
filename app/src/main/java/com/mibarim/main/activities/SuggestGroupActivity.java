 ...
 */
public class SuggestGroupActivity extends BootstrapActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (getIntent() != null && getIntent().getExtras() != null) {
            ...
            theGroup = (GroupModel) getIntent().getExtras().getSerializable("GroupModel");
        }
    ...
    public void onNetworkErrorEvent(NetworkErrorEvent event) {
        Toaster.showLong(SuggestGroupActivity.this, getString(R.string.network_error), R.drawable.toast_warn);
    }
    ...
    public Bitmap getRouteImage(final long routeId, final String requestedFragment) {
        new SafeAsyncTask<Boolean>() {
            ...
            public Boolean call() throws Exception {
                if (authToken == null) {
                    authToken = serviceProvider.getAuthToken(SuggestGroupActivity.this);
                }
...
//                    finish();
    ...
    public Location getRouteSource() {
        ...
        if (theRoute != null) {
            loc.lat = theRoute.SrcLatitude;
            loc.lng = theRoute.SrcLongitude;
    ...
    public Location getRouteDestination() {
        Location loc = new Location();
        if (theRoute != null) {
            loc.lat = theRoute.DstLatitude;
            loc.lng = theRoute.DstLongitude;
    ...
    public void setRouteSrcDst(String srcLat, String srcLng, String dstLat, String dstLng, int position) {
        ...
        ((MapFragment) fragment).setRoute(srcLat, srcLng, dstLat, dstLng, position);

    }


    public GroupModel getSuggestGroupRoutes() {
        return theGroup;
    }
    ...
    public void joinGroup() {
        new SafeAsyncTask<Boolean>() {
            ...
            public Boolean call() throws Exception {
                ...
                response = routeRequestService.joinGroup(authToken, String.valueOf(theRoute.RouteId),
                        String.valueOf(theGroup.GroupId));
...
//                    finish();
            ...
            protected void onSuccess(final Boolean succees) throws Exception {
                if (!succees) {
                    new HandleApiMessages(SuggestGroupActivity.this, response).showMessages();
                }else {
                    finishIt();
                }
    ...
    public void deleteGroupSuggest() {
        new SafeAsyncTask<Boolean>() {
            @Override
            public Boolean call() throws Exception {
                if (authToken == null) {
                ...
                response = routeRequestService.deleteGroup(authToken, String.valueOf(theRoute.RouteId),
                        String.valueOf(theGroup.GroupId));
                if ((response.Errors == null || response.Errors.size() == 0) && response.Status.equals("OK")) {
                    return true;
                }
